...
public class Level4Button : MonoBehaviour, IGvrGazeResponder {
    ...
    void CheckStars()
    {
        if (PlayerPrefs.GetString("Level4PassedWith") == "Level4D" || PlayerPrefs.GetString("Level4PassedWith") == "Level4DD")
        {
            star1.enabled = true;
        }
        else if (PlayerPrefs.GetString("Level4PassedWith") == "Level4C" || PlayerPrefs.GetString("Level4PassedWith") == "Level4CC")
        {
            star1.enabled = true;
            star2.enabled = true;
        }
        else if (PlayerPrefs.GetString("Level4PassedWith") == "Level4B" || PlayerPrefs.GetString("Level4PassedWith") == "Level4BB" || PlayerPrefs.GetString("Level4PassedWith") == "Level4A")
        {
            star1.enabled = true;
            star2.enabled = true;
            star3.enabled = true;
        }
        else if (PlayerPrefs.GetString("Level4PassedWith") == "Level4AA")
        {
            star1.enabled = true;
            star2.enabled = true;
            star3.enabled = true;
