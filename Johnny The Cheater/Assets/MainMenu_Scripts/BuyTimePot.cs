...
public class BuyTimePot : MonoBehaviour, IGvrGazeResponder {

	public Image circle;
	public GameObject greenPotImage;
	...
	void Update () {
		if (PlayerPrefs.GetInt("ShopPoint") >= shop.timePotionPrice) {
			greenPotImage.GetComponent<SpriteRenderer> ().material.color = new Color (1f, 1f, 1f, 1f);
			priceInfo.color = Color.black;
			isDisabled = false;
		} else {
			greenPotImage.GetComponent<SpriteRenderer> ().material.color = new Color (1f, 1f, 1f, 0.4f);
